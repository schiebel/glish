...
class Stmt : public GlishObject {
	...
	virtual Value* Exec( bool value_needed, stmt_flow_type& flow );
	...
	virtual bool IsActiveFor( Agent* agent, const char* field,
					Value* value ) const;

	// Sets the statement's activity, either to true (if "activate" is
	// true) or to false.
	virtual void SetActivity( bool activate );
	...
	virtual Value* DoExec( bool value_needed, stmt_flow_type& flow ) = 0;
...
class SeqStmt : public Stmt {
	...
	Value* DoExec( bool value_needed, stmt_flow_type& flow );
...
class WheneverStmt : public Stmt {
	...
	bool IsActiveFor( Agent* agent, const char* field, Value* value ) const;
...
class ActivateStmt : public Stmt {
    public:
	ActivateStmt( bool activate, Expr* e, Sequencer* sequencer );
