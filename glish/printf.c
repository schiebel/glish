...
#define GETINT(lhs) lhs = ap->IntPtr(0)[index];
char **
doit( char *cbuf, char *convp, const IValue *ap, int index, int ndyn, int cch, int cty)
{
	register char *s;
